...
Veuillez répondre poliment aux questions de l'utilisateur en français.`
  ...
  private appendDomainContext(prompt: string): string {
    const domainContext = [
      ...
      'DOMAIN HINT: The conversation domain likely includes keywords about Java, TypeScript, AWS, OCI, GitHub Actions, CI/CD, OpenAI, Anthropic, unit tests, and E2E. Preserve product names and acronyms in English.'
    ].join(' ');
